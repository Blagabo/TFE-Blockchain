...
import Drones from '../artifacts/contracts/Drones.sol/Drones.json'
...
export default function TotalSupply() {
    ...
    async function getTotalSupply() {
        try {
          ...
          const contract = new ethers.Contract(process.env.NEXT_PUBLIC_MINTER_ADDRESS, Drones.abi, provider)
